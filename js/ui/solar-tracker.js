...
class SolarTracker {
    ...
    calculateEclipseGroundPath() {
        ...
        for (let i = 0; i <= steps; i++) {
            ...
            const sunPos = AstronomyCalculator.calculateSunPosition(time, centerLat, centerLon);
    ...
    updateCurrentPosition() {
        ...
        try {
            const sunPos = AstronomyCalculator.calculateSunPosition(now, calcLat, calcLon);
